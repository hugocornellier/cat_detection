          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection(context, 'Cat Detection / Landmarks', [
                  _buildModeCard(
                    context,
                    icon: Icons.videocam,
                    title: 'Live Camera',
                    description: 'Real-time cat detection from camera feed',
                  ...
                  _buildModeCard(
                    ...
                    icon: Icons.image,
                    title: 'Still Image',
                    description: 'Detect cats in photos from gallery or camera',
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                  ...
                  _buildModeCard(
                    ...
                    title: 'Video File',
                    description:
                        'Process an MP4 frame-by-frame with smoothed cat detection',
                    onTap: () => Navigator.push(
                      context,
                      MaterialPageRoute(
